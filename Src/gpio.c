...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PA1 PA4 PA7 PA10
                           PA11 PA12 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_4|GPIO_PIN_7|GPIO_PIN_10
  ...
  GPIO_InitStruct.Pin = DeclenchementRobot_Pin|SelectionEquipe_Pin;
