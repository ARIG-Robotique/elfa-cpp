...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MOT_STBY_2_GPIO_Port, MOT_STBY_2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PG14 PG15 PG11 PG10
                           PG9 PG8 PG7 PG1
                           PG3 PG2 PG0 PG5
                           PG4 */
  GPIO_InitStruct.Pin = GPIO_PIN_14|GPIO_PIN_15|GPIO_PIN_11|GPIO_PIN_10
  ...
  /*Configure GPIO pins : PD7 PD6 PD0 PD3
                           PD1 PD2 PD15 PD10
                           PD14 PD9 PD8 PD12
                           PD13 PD11 */
  GPIO_InitStruct.Pin = GPIO_PIN_7|GPIO_PIN_6|GPIO_PIN_0|GPIO_PIN_3
                          |GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_15|GPIO_PIN_10
  ...
  /*Configure GPIO pins : PC12 PC13 PC9 PC8
                           PC7 PC6 PC3 PC0
                           PC1 PC2 PC4 PC5 */
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_9|GPIO_PIN_8
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_11|GPIO_PIN_10|GPIO_PIN_9
                          |GPIO_PIN_8|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_3;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_15|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_4
                          ...
                          |GPIO_PIN_7|GPIO_PIN_9|GPIO_PIN_11|GPIO_PIN_8
                          |GPIO_PIN_10;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = MOT_STBY_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MOT_STBY_2_GPIO_Port, &GPIO_InitStruct);
