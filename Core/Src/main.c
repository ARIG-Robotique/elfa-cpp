...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OTG_FS1_PowerSwitchOn_Pin|EXT_RESET_Pin|MOT_STBY_Pin|MOT_AIN1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, GPIO_PIN_7|MOT_AIN2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LCD_BL_CTRL_Pin|MOT_PWM_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PRES_AVANT_Pin uSD_Detect_Pin */
  GPIO_InitStruct.Pin = PRES_AVANT_Pin|uSD_Detect_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : OTG_FS1_PowerSwitchOn_Pin EXT_RESET_Pin MOT_STBY_Pin MOT_AIN1_Pin */
  GPIO_InitStruct.Pin = OTG_FS1_PowerSwitchOn_Pin|EXT_RESET_Pin|MOT_STBY_Pin|MOT_AIN1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : LCD_BL_CTRL_Pin MOT_PWM_Pin */
  GPIO_InitStruct.Pin = LCD_BL_CTRL_Pin|MOT_PWM_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void StartDefaultTask(void const * argument)
{
  ...
  HAL_GPIO_WritePin(MOT_PWM_GPIO_Port, MOT_PWM_Pin, GPIO_PIN_RESET);
  ...
  for(;;)
  {
	  ...
	  case STATUETTE_OK:
		  ...
		  HAL_GPIO_WritePin(MOT_PWM_GPIO_Port, MOT_PWM_Pin, GPIO_PIN_SET);
		  break;
	  }
